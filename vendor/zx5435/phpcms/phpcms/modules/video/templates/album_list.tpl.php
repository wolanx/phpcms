...
<li>
	<div class="img-wrap">
		<a href="javascript:void(0);" vid="<?php echo $r['videoid']?>" picp="<?php echo $r['picpath']?>" onclick="javascript:album_cancel(this,'<?php echo $r['videoid']?>','<?php echo $r['picpath']?>')"><div class="icon"></div><img src="<?php echo $r['picpath']?>" vid="<?php echo $r['videoid'];?>" path="<?php echo $r['picpath'];?>" width="120" title="<?php echo $r['title']?>"/></a><?php echo $r['title'];?>
	</div>
</li>
<?php } ?>
</ul>
