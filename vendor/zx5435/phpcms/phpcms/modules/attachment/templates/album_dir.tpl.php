...
<?php if (is_dir($v)) {
	...
	echo '<td align="left" onclick="javascript:album_cancel(this)"><img src="'.file_icon($filename,'gif').'" /> <a href="javascript:void(0);" rel="'.$url.$filename.'" title="'.$filename.'">'.$filename.'</a></td>';
}?>
</tr>
<?php 
	endforeach;
