...
class search_type extends admin
{
    ...
    public function init()
    {
        ...
        $result_datas = $this->db->listinfo(['siteid' => $this->siteid, 'module' => 'search'], 'listorder ASC', $page);
        $pages = $this->db->pages;
    ...
    public function add()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            $module_data = ['special' => L('special'), 'content' => L('content') . L('module'), 'yp' => L('yp')];
    ...
    public function listorder()
    {
        if (isset($_POST['dosubmit'])) {
            foreach ($_POST['listorders'] as $id => $listorder) {
                $this->db->update(['listorder' => $listorder], ['typeid' => intval($id)]);
            }
    ...
    {
        $datas = $search_model = [];
        $result_datas = $result_datas2 = $this->db->select(['siteid' => $this->siteid, 'module' => 'search'], '*', 1000, 'listorder ASC');
