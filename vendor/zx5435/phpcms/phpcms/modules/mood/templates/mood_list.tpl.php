            ...
            <tr>
                <td>
                    <div class="explain-col">
                        ...
                        <?php echo L('time') ?>：<?php echo form::select(['1' => L('today'), '2' => L('yesterday'), '3' => L('this_week'), '4' => L('this_month'), '5' => L('all')],
            ...
            <table width="100%" cellspacing="0">
                ...
                if (is_array($data) && !empty($data)) {
                    foreach ($data as $k => $v) {
                        ?>
                        <tr>
                            <td align="left"><a href="<?php echo $content_data[$v['contentid']]['url'] ?>" target="_blank"><?php echo $content_data[$v['contentid']]['title'] ?></a>
                            </td>
                            <td align="left" <?php if ($order == -1) {
                                echo 'class="on"';
                            } ?>><?php echo $v['total'] ?></td>
