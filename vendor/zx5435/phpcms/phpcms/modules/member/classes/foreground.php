...
class foreground
{
    ...
    final public function check_member()
    {
        ...
        if (ROUTE_M == 'member' && ROUTE_C == 'index' && in_array(ROUTE_A, ['login', 'register', 'mini', 'send_newmail'])) {
            ...
            if ($phpcms_auth) {
                ...
                //验证用户，获取用户信息
                $this->memberinfo = $this->db->get_one(['userid' => $userid]);
                ...
                $this->_member_modelinfo = $this->db->get_one(['userid' => $userid]);
                $this->_member_modelinfo = $this->_member_modelinfo ? $this->_member_modelinfo : [];
                $this->db->set_model();
