    ...
    <div class="common-form">
        <fieldset>
            ...
            <table width="100%" class="table_form contentWrap">
                <tr>
                    <th><strong><?= L('filedtype') ?></strong><br/></th>
                    <td>
                        <?= form::select($fields, '', 'name="info[formtype]" id="formtype" onchange="javascript:field_setting(this.value);"', L('filedtype_need')); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo L('min') ?><input type="text" name="info[minlength]" id="field_minlength" value="0" size="5" class="input-text"> <?php echo L('max') ?>
                        <input type="text" name="info[maxlength]" id="field_maxlength" value="" size="5" class="input-text"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="info[isunique]" value="1" id="field_allow_isunique1"> <?php echo L('yes') ?>
                        <input type="radio" name="info[isunique]" value="0" id="field_allow_isunique0" checked> <?php echo L('no') ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('can_empty') ?></strong></th>
                    <td>
                        <input type="radio" name="info[isbase]" value="1" checked> <?php echo L('yes') ?>
                        <input type="radio" name="info[isbase]" value="0"> <?php echo L('no') ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('search_condition') ?></strong></th>
                    <td>
                        <input type="radio" name="info[issearch]" value="1" id="field_allow_search1"> <?php echo L('yes') ?>
                        <input type="radio" name="info[issearch]" value="0" id="field_allow_search0" checked> <?php echo L('no') ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('isadd_condition') ?></strong></th>
                    <td>
                        <input type="radio" name="info[isadd]" value="1" checked><?php echo L('yes') ?>
                        <input type="radio" name="info[isadd]" value="0"><?php echo L('no') ?>
                    </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('isomnipotent_condition') ?></strong></th>
                    <td>
                        <input type="radio" name="info[isomnipotent]" value="1"><?php echo L('yes') ?>
                        <input type="radio" name="info[isomnipotent]" value="0" checked><?php echo L('no') ?>
                    </td>
                </tr>
                <tr>
