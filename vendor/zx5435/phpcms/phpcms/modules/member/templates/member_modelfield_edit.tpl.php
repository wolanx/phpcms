...
<script>
    $(function () {
        ...
        }).regexValidator({regexp: "^[a-zA-Z]{1}([a-zA-Z0-9]|[_]){0,19}$", onerror: "<?php echo L('filedname_incorrect')?>"}).inputValidator({
            min: 1,
            max: 20,
        ...
        $("#formtype").formValidator({
            onshow: "<?php echo L('filedtype_need')?>",
            onfocus: "<?php echo L('filedtype_need')?>",
            oncorrect: "<?php echo L('input_correct')?>",
            defaultvalue: ""
        }).inputValidator({min: 1, onerror: "<?php echo L('filedtype_need')?>"});
        $("#name").formValidator({
            onshow: "<?php echo L('filed_nickname_need')?>",
            onfocus: "<?php echo L('filed_nickname_need')?>",
            oncorrect: "<?php echo L('input_correct')?>"
        }).inputValidator({min: 1, onerror: "<?php echo L('filed_nickname_need')?>"});
    })
</script>
<div class="pad-10">
                ...
                <table width="100%" class="table_form contentWrap">
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo form::select($fields, $formtype, 'name="info[formtype]" id="formtype" onchange="javascript:field_setting(this.value);" disabled',
                                L('filedtype_need')); ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo L('min') ?><input type="text" name="info[minlength]" id="field_minlength" value="<?php echo $minlength; ?>" size="5"
                                                         class="input-text"> <?php echo L('max') ?><input type="text" name="info[maxlength]" id="field_maxlength"
