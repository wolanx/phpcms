        ...
        <fieldset>
            ...
            <table width="100%" class="table_form">
                ...
                <tr>
                    ...
                    <td class="y-bg">
                        <input type="text" class="input-text" name="setting[thumb_w]" id="thumb_w" size="5" value="220">px　*　
                        <input type="text" class="input-text" name="setting[thumb_h]" id="thumb_h" size="5" value="0">px
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="y-bg">
                        <textarea style="height: 100px; width: 200px;" id="options" cols="20" rows="2" name="setting[hotwords]"><?php echo $hotwords ?></textarea>
                        <?php echo L('wap_hotword_desc') ?>
                    </td>
                </tr>
            </table>
