...
<script>
    $(function () {
        ...
        $("#name").formValidator({onshow: "<?php echo L('input') . L('name')?>", onfocus: "<?php echo L('input') . L('name')?>"}).inputValidator({
            ...
            type: "get", url: "", data: "m=block&c=block_admin&a=public_name&id=<?php if (isset($id) && !empty($id)) {
                echo $id;
...
<div class="pad-10">
    <form action="?m=block&c=block_admin&a=<?php echo ROUTE_A ?>&pos=<?php echo $_GET['pos'] ?>&id=<?php if (isset($id) && !empty($id)) {
        echo $id;
            ...
            <fieldset>
                ...
                <table width="100%" class="table_form">
                    ...
                    <tr>
                        ...
                        <td class="y-bg"><?php echo form::radio(['1' => L('code'), '2' => L('table_style')], (isset($data['type']) ? $data['type'] : 1),
                                'name="type"' . (ROUTE_A == 'edit' ? ' disabled = "disabled"' : '')) ?></td>
                    </tr>
                </table>
            </fieldset>
            <div class="bk15"></div>
