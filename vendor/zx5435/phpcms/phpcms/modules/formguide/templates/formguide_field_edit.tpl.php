...
<a href="javascript:void(0);" class="on"><em><?php echo L('edit_field');?></em></a><span>|</span><a href="?m=formguide&c=formguide_field&a=init&formid=<?php echo $formid?>&menuid=<?php echo $_GET['menuid']?>"><em><?php echo L('manage_field');?></em></a><span>|</span></div>
  <div class="bk10"></div>
</div>
