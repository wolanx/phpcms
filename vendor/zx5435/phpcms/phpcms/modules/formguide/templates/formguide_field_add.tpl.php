...
<script type="text/javascript">
    $(function () {
        ...
        $("#name").formValidator({
            ...
            oncorrect: "<?php echo L('input_right');?>"
        }).inputValidator({min: 1, onerror: "<?php echo L('input_nickname');?>"});
    })
</script>
<div class="subnav">
    ...
    <div class="content-menu ib-a blue line-x"><a class="add fb"
                                                  href="?m=formguide&c=formguide_field&a=add&modelid=<?php echo $formid ?>&menuid=<?php echo $_GET['menuid'] ?>"><em><?php echo L('add_field'); ?></em></a>
        　<?php if (isset($formid) && !empty($formid)) { ?><a href="?m=formguide&c=formguide_field&a=init&modelid=<?php echo $formid ?>&menuid=<?php echo $_GET['menuid'] ?>">
            <em><?php echo L('manage_field'); ?></em></a><?php } else { ?><a href="?m=formguide&c=formguide_field&a=init&menuid=<?php echo $_GET['menuid'] ?>">
            <em><?php echo L('public_field_manage') ?></em></a><?php } ?></div>
    <div class="bk10"></div>
</div>
    ...
    <div class="common-form">
        ...
        <table width="100%" class="table_form contentWrap">
            ...
            <tr>
                ...
                <td><?php echo L('minlength'); ?>：<input type="text" name="info[minlength]" id="field_minlength" value="0" size="5"
                                                         class="input-text"> <?php echo L('maxlength'); ?>：<input type="text" name="info[maxlength]" id="field_maxlength"
                                                                                                                  value="" size="5" class="input-text"></td>
            </tr>
            <tr>
