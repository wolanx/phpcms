...
use phpcms\modules\content\fields\content_output;
...
class index
{
    ...
    public function show()
    {
        ...
        if (empty($previous_page)) {
            $previous_page = ['title' => L('first_page'), 'thumb' => IMG_PATH . 'nopic_small.gif', 'url' => 'javascript:alert(\'' . L('first_page') . '\');'];
        }

        if (empty($next_page)) {
            $next_page = ['title' => L('last_page'), 'thumb' => IMG_PATH . 'nopic_small.gif', 'url' => 'javascript:alert(\'' . L('last_page') . '\');'];
        }
    ...
    protected function _category_priv($catid)
    {
        ...
        $this->category_priv_db = new category_priv_model();
