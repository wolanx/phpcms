...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#workname").formValidator({
            onshow: "<?php echo L("input") . L('workflow_name')?>",
            onfocus: "<?php echo L("input") . L('workflow_name')?>",
            oncorrect: "<?php echo L('input_right');?>"
        }).inputValidator({min: 1, onerror: "<?php echo L("input") . L('workflow_name')?>"});
    })
    //-->
</script>
<div class="pad-lr-10">
    <form action="?m=content&c=workflow&a=edit" method="post" id="myform">
        <table width="100%" class="table_form">
            ...
            <tr>
                ...
                <td class="y-bg">
                    <select name="info[steps]" onchange="select_steps(this.value)">
                        <option value='1' <?php if ($steps == 1) {
                            echo 'selected';
                        } ?>><?php echo L('steps_1'); ?></option>
                        <option value='2' <?php if ($steps == 2) {
                            echo 'selected';
                        } ?>><?php echo L('steps_2'); ?></option>
                        <option value='3' <?php if ($steps == 3) {
                            echo 'selected';
                        } ?>><?php echo L('steps_3'); ?></option>
                        <option value='4' <?php if ($steps == 4) {
                            echo 'selected';
                        } ?>><?php echo L('steps_4'); ?></option>
                    </select></td>
            </tr>
            <tr id="step1">
            ...
            <tr id="step2" style="display:<?php if ($steps < 2) {
                echo 'none';
            } ?>">
            ...
            <tr id="step3" style="display:<?php if ($steps < 3) {
                echo 'none';
            } ?>">
            ...
            <tr id="step4" style="display:<?php if ($steps < 4) {
                echo 'none';
            } ?>">
            ...
            <tr>
                ...
                <td class="y-bg">
                    <input type="radio" name="info[flag]" value="1" <?php if ($flag) {
                        echo 'checked';
                    } ?>> 是
                    <input type="radio" name="info[flag]" value="0" <?php if (!$flag) {
                        echo 'checked';
                    } ?>> 否
                </td>
            </tr>
