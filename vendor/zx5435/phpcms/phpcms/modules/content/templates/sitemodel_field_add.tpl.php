...
<div class="subnav">
    ...
    <div class="content-menu ib-a blue line-x"><a class="add fb"
                                                  href="?m=content&c=sitemodel_field&a=add&modelid=<?php echo $modelid ?>&menuid=<?php echo $_GET['menuid'] ?>"><em><?php echo L('add_field'); ?></em></a>
            ...
            <table width="100%" class="table_form contentWrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="info[issystem]" id="field_basic_table1" value="1" onclick="$('#issystem').val('1');"> <?php echo L('yes'); ?> <input type="radio"
                                                                                                                                                                       id="field_basic_table0"
                                                                                                                                                                       name="info[issystem]" value="0"
                                                                                                                                                                       onclick="$('#issystem').val('0');"
                                                                                                                                                                       checked> <?php echo L('no'); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo L('minlength'); ?>：<input type="text" name="info[minlength]" id="field_minlength" value="0" size="5" class="input-text"> <?php echo L('maxlength'); ?>：<input
                                type="text" name="info[maxlength]" id="field_maxlength" value="" size="5" class="input-text"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isunique]" value="1" id="field_allow_isunique1"> <?php echo L('yes'); ?> <input type="radio" name="info[isunique]" value="0"
                                                                                                                                       id="field_allow_isunique0" checked> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[issearch]" value="1" id="field_allow_search1"> <?php echo L('yes'); ?> <input type="radio" name="info[issearch]" value="0"
                                                                                                                                     id="field_allow_search0" checked> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isfulltext]" value="1" id="field_allow_fulltext1" checked/> <?php echo L('yes'); ?> <input type="radio" name="info[isfulltext]" value="0"
                                                                                                                                                  id="field_allow_fulltext0"/> <?php echo L('no'); ?>
                    </td>
                </tr>
                <tr>
