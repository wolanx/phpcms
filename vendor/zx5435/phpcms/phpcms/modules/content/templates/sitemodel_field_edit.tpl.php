...
<script type="text/javascript">
    $(function () {
        ...
        }).regexValidator({regexp: "^[a-zA-Z]{1}([a-zA-Z0-9]|[_]){0,19}$", onerror: "<?php echo L('fieldname_was_wrong');?>"}).inputValidator({
            min: 1,
            max: 20,
        ...
        $("#formtype").formValidator({
            onshow: "<?php echo L('select_fieldtype');?>",
            onfocus: "<?php echo L('select_fieldtype');?>",
            oncorrect: "<?php echo L('input_right');?>",
            defaultvalue: ""
        }).inputValidator({min: 1, onerror: "<?php echo L('select_fieldtype');?>"});
        $("#name").formValidator({onshow: "<?php echo L('input_nickname');?>", onfocus: "<?php echo L('nickname_empty');?>", oncorrect: "<?php echo L('input_right');?>"}).inputValidator({
            min: 1,
...
<div class="pad_10">
    <div class="subnav">
        ...
        <div class="content-menu ib-a blue line-x">
            <a href="javascript:void(0);" class="on"><em><?php echo L('edit_field'); ?></em></a><span>|</span><a
                    href="?m=content&c=sitemodel_field&a=init&modelid=<?php echo $modelid ?>&menuid=<?php echo $_GET['menuid'] ?>"><em><?php echo L('manage_field'); ?></em></a><span>|</span></div>
        <div class="bk10"></div>
    </div>
            ...
            <table width="100%" class="table_form">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="info[issystem]" id="field_basic_table1" value="1" <?php if ($issystem) {
                            echo 'checked';
                        } ?> disabled> <?php echo L('yes'); ?> <input type="radio" id="field_basic_table0" name="info[issystem]" value="0" <?php if (!$issystem) {
                            echo 'checked';
                        } ?> disabled> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                    <th width="25%"><font color="red">*</font> <strong><?php echo L('fieldname'); ?></strong><br/>
                        <?php echo L('fieldname_tips'); ?>
                    </th>
                    <td><input type="text" name="info[field]" id="field" size="20" class="input-text" value="<?php echo $field ?>" <?php if (in_array($field, $forbid_delete)) {
                            echo 'readonly';
                        } ?>></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo L('minlength'); ?>：<input type="text" name="info[minlength]" id="field_minlength" value="<?php echo $minlength; ?>" size="5"
                                                             class="input-text"><?php echo L('maxlength'); ?>：<input type="text" name="info[maxlength]" id="field_maxlength"
                                                                                                                     value="<?php echo $maxlength; ?>" size="5" class="input-text"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isunique]" value="1" id="field_allow_isunique1" <?php if ($isunique) {
                            echo 'checked';
                        } ?> <?php if (!$field_allow_isunique) {
                            echo 'disabled';
                        } ?>> <?php echo L('yes'); ?> <input type="radio" name="info[isunique]" value="0" id="field_allow_isunique0" <?php if (!$isunique) {
                            echo 'checked';
                        } ?> <?php if (!$field_allow_isunique) {
                            echo 'disabled';
                        } ?>> <?php echo L('no'); ?></td>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isbase]" value="1" <?php if ($isbase) {
                            echo 'checked';
                        } ?>> <?php echo L('yes'); ?> <input type="radio" name="info[isbase]" value="0" <?php if (!$isbase) {
                            echo 'checked';
                        } ?>> <?php echo L('no'); ?> </td>
                </tr>
                <tr>
                    <th><strong><?php echo L('as_search_field'); ?></strong></th>
                    <td><input type="radio" name="info[issearch]" value="1" id="field_allow_search1" <?php if ($issearch) {
                            echo 'checked';
                        } ?> <?php if (!$field_allow_search) {
                            echo 'disabled';
                        } ?>> <?php echo L('yes'); ?> <input type="radio" name="info[issearch]" value="0" id="field_allow_search0" <?php if (!$issearch) {
                            echo 'checked';
                        } ?> <?php if (!$field_allow_search) {
                            echo 'disabled';
                        } ?>> <?php echo L('no'); ?></td>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isadd]" value="1" <?php if ($isadd) {
                            echo 'checked';
                        } ?>/> <?php echo L('yes'); ?> <input type="radio" name="info[isadd]" value="0" <?php if (!$isadd) {
                            echo 'checked';
                        } ?>/> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                    ...
                    <td><input type="radio" name="info[isfulltext]" value="1" id="field_allow_fulltext1" <?php if ($isfulltext) {
                            ...
                            echo 'disabled';
                        } ?>/> <?php echo L('yes'); ?> <input type="radio" name="info[isfulltext]" value="0" id="field_allow_fulltext0" <?php if (!$isfulltext) {
                            echo 'checked';
                        } ?> <?php if (!$field_allow_fulltext) {
                            echo 'disabled';
                        } ?>/> <?php echo L('no'); ?></td>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="info[isomnipotent]" value="1" <?php if ($isomnipotent) {
                            echo 'checked';
                        } ?> <?php
                        if (in_array($field, $forbid_fields)) {
                            echo 'disabled';
                        } ?>/> <?php echo L('yes'); ?> <input type="radio" name="info[isomnipotent]" value="0" <?php if (!$isomnipotent) {
                            echo 'checked';
                        } ?> /> <?php echo L('no'); ?></td>
                </tr>
                <tr>
                    <th><strong><?php echo L('as_postion_info'); ?></strong></th>
                    <td><input type="radio" name="info[isposition]" value="1" <?php if ($isposition) {
                            echo 'checked';
                        } ?> /> <?php echo L('yes'); ?> <input type="radio" name="info[isposition]" value="0" <?php if (!$isposition) {
                            echo 'checked';
                        } ?>/> <?php echo L('no'); ?></td>
                </tr>
