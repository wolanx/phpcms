...
class content_tag
{
    ...
    public function __construct()
    {
        ...
        $this->position = new position_data_model;
    }
    ...
    public function relation($data)
    {
        ...
        if ($data['relation']) {
            ...
            $relations = array_diff($relations, [null]);
    ...
    public function category($data)
    {
        ...
        $i = 1;
        is_array($categorys) ? null : $categorys = [];
    ...
    public function pc_tag()
    {
        ...
        return [
            'action'   => [
                'lists'    => L('list', '', 'content'),
                'position' => L('position', '', 'content'),
                'category' => L('subcat', '', 'content'),
                'relation' => L('related_articles', '', 'content'),
                'hits'     => L('top', '', 'content'),
            ],
            'lists'    => [
                'catid'    => ['name' => L('catid', '', 'content'), 'htmltype' => 'input_select_category', 'data' => ['type' => 0], 'validator' => ['min' => 1]],
                'order'    => [
                    'name'     => L('sort', '', 'content'),
                    'htmltype' => 'select',
                    'data'     => ['id DESC' => L('id_desc', '', 'content'), 'updatetime DESC' => L('updatetime_desc', '', 'content'), 'listorder ASC' => L('listorder_asc', '', 'content')],
                ],
                'thumb'    => ['name' => L('thumb', '', 'content'), 'htmltype' => 'radio', 'data' => ['0' => L('all_list', '', 'content'), '1' => L('thumb_list', '', 'content')]],
                'moreinfo' => ['name' => L('moreinfo', '', 'content'), 'htmltype' => 'radio', 'data' => ['1' => L('yes'), '0' => L('no')]],
            ],
            'position' => [
                'posid' => ['name' => L('posid', '', 'content'), 'htmltype' => 'input_select', 'data' => $poslist, 'validator' => ['min' => 1]],
                'catid' => ['name' => L('catid', '', 'content'), 'htmltype' => 'input_select_category', 'data' => ['type' => 0], 'validator' => ['min' => 0]],
                'thumb' => ['name' => L('thumb', '', 'content'), 'htmltype' => 'radio', 'data' => ['0' => L('all_list', '', 'content'), '1' => L('thumb_list', '', 'content')]],
                'order' => [
                    'name'     => L('sort', '', 'content'),
                    'htmltype' => 'select',
                    'data'     => ['listorder DESC' => L('listorder_desc', '', 'content'), 'listorder ASC' => L('listorder_asc', '', 'content'), 'id DESC' => L('id_desc', '', 'content')],
                ],
            ],
            'category' => [
                'siteid' => ['name' => L('siteid'), 'htmltype' => 'input_select', 'data' => $sitelist],
                'catid'  => ['name' => L('catid', '', 'content'), 'htmltype' => 'input_select_category', 'data' => ['type' => 0]],
            ],
            'relation' => [
                'catid'    => ['name' => L('catid', '', 'content'), 'htmltype' => 'input_select_category', 'data' => ['type' => 0], 'validator' => ['min' => 1]],
                'order'    => [
                ...
                'relation' => ['name' => L('relevant_articles_id', '', 'content'), 'htmltype' => 'input'],
                'keywords' => ['name' => L('key_word', '', 'content'), 'htmltype' => 'input'],
            ],
            'hits'     => [
                'catid' => ['name' => L('catid', '', 'content'), 'htmltype' => 'input_select_category', 'data' => ['type' => 0], 'validator' => ['min' => 1]],
                'day'   => ['name' => L('day_select', '', 'content'), 'htmltype' => 'input', 'data' => ['type' => 0]],
            ],
