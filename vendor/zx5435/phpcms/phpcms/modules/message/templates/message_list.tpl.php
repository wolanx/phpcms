            ...
            <tr>
                <td>
                    <div class="explain-col"><?php echo L('query_type') ?>:<?php echo form::select($trade_status, $status, 'name="search[status]"',
                            L('all')) ?>      <?php echo L('username') ?>: <input type="text" value="" class="input-text" name="search[username]"> <?php echo L('time') ?>
                        : <?php echo form::date('search[start_time]', '', '') ?> <?php echo L('to') ?>   <?php echo form::date('search[end_time]', '', '') ?> <input type="submit"
                    ...
                    foreach ($infos as $info) {
                        ...
                        <tr>
                            ...
                            <td align="center" width="15%"><a
                                        ...
                                        onClick="return confirm('<?php echo L('confirm', ['message' => new_addslashes($info['subject'])]) ?>')"><?php echo L('delete') ?></a>
                            </td>
                        </tr>
                        <?php
                    }
