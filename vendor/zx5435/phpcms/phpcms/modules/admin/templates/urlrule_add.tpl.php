...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#file").formValidator({onshow: "<?php echo L('input') . L('urlrule_file')?>", onfocus: "<?php echo L('input') . L('urlrule_file')?>"}).regexValidator({
            regexp: "^([a-zA-Z0-9]|[_]){0,20}$",
            onerror: "<?php echo L('enter_the_correct_catname');?>"
        }).inputValidator({min: 1, onerror: "<?php echo L('input') . L('urlrule_file')?>"});
        $("#example").formValidator({onshow: "<?php echo L('input') . L('urlrule_example')?>", onfocus: "<?php echo L('input') . L('urlrule_example')?>"}).inputValidator({
            min: 1,
            onerror: "<?php echo L('input') . L('urlrule_example')?>"
        });
        $("#urlrule").formValidator({onshow: "<?php echo L('input') . L('urlrule_url')?>", onfocus: "<?php echo L('input') . L('urlrule_url')?>"}).inputValidator({
            min: 1,
            onerror: "<?php echo L('input') . L('urlrule_url')?>"
        });
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
        <form action="?m=admin&c=urlrule&a=add" method="post" name="myform" id="myform">
            ...
            <tr>
                ...
                <td><?php echo L('complete_part_path'); ?>： <input type="text" name="f1" value="{$categorydir}" size="15" class="input-botton">，<?php echo L('category_path'); ?>：<input type="text"
                                                                                                                                                                                         name="f1"
                                                                                                                                                                                         value="{$catdir}"
                                                                                                                                                                                         size="10"
                                                                                                                                                                                         class="input-botton">
                    ...
                    <?php echo L('year'); ?>：<input type="text" name="f1" value="{$year}" size="7" class="input-botton"> <?php echo L('month'); ?>：<input type="text" name="f1" value="{$month}"
                                                                                                                                                          size="9"
                                                                                                                                                          class="input-botton">，<?php echo L('day'); ?>：<input
                            type="text" name="f1" value="{$day}" size="7" class="input-botton"> ID：<input type="text" name="f1" value="{$id}" size="4" class="input-botton">， <?php echo L('paging'); ?>
                    ：<input type="text" name="f1" value="{$page}" size="7" class="input-botton">
                </td>
            </tr>
