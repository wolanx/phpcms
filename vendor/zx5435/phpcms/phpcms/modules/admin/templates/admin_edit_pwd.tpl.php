...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#old_password").formValidator({
            empty: true,
            onshow: "<?php echo L('not_change_the_password_please_leave_a_blank')?>",
            onfocus: "<?php echo L('password') . L('between_6_to_20')?>",
            oncorrect: "<?php echo L('old_password_right')?>"
        }).inputValidator({min: 6, max: 20, onerror: "<?php echo L('password') . L('between_6_to_20')?>"}).ajaxValidator({
            type: "get",
            url: "",
        ...
        }).compareValidator({desid: "new_password", operateor: "=", onerror: "<?php echo L('input') . L('passwords_not_match')?>"});
    })
</script>
<div class="pad_10">
        ...
        <form name="myform" action="?m=admin&c=admin_manage&a=public_edit_pwd" method="post" id="myform">
            ...
            <table width="100%" class="table_form contentWrap">
                ...
                <tr>
                    ...
                    <td><input type="password" name="old_password" id="old_password" class="input-text"></td>
                </tr>

                <tr>
                    <td><?php echo L('new_password') ?></td>
                    <td><input type="password" name="new_password" id="new_password" class="input-text"></td>
                </tr>
                <tr>
                    <td><?php echo L('new_pwdconfirm') ?></td>
                    <td><input type="password" name="new_pwdconfirm" id="new_pwdconfirm" class="input-text"></td>
                </tr>
