...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#name").formValidator({onshow: "<?php echo L('input') . L('linkage_name')?>", onfocus: "<?php echo L('linkage_name') . L('not_empty')?>"}).inputValidator({
            min: 1,
            max: 999,
                ...
                <?php } else { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="info[style]" value="2" type="radio" <?php if ($style == 2) { ?>checked<?php } ?>>&nbsp;<?php echo L('linkage_select_style') ?>
                            ,<?php echo L('linkage_select_show') ?><input type="text" name="info[level]" value="<?php echo $setting['level'] ?>" class="input-text" id="level"
                                                                          size="5"></input><?php echo L('linkage_select_level') ?>
                        </td>
                    </tr>
                    <tr>
