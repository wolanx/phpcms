...
<script type="text/javascript">
    $(function () {
        ...
        $("#catdir").formValidator({onshow: "<?php echo L('input_dirname');?>", onfocus: "<?php echo L('input_dirname');?>"}).regexValidator({
        ...
        $("#url").formValidator({
            ...
            tipcss: {width: '300px'},
            empty: true
        }).inputValidator({onerror: "<?php echo L('domain_name_format');?>"}).regexValidator({regexp: "http:\/\/(.+)\/$", onerror: "<?php echo L('domain_end_string');?>"});
            ...
            <div id="div_setting_1" class="contentList pad-10">
                ...
                <table width="100%" class="table_form ">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo form::select_category('category_content_' . $this->siteid, $parentid, 'name="info[parentid]" id="parentid"',
                                L('please_select_parent_category'), 0, -1); ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='info[ismenu]' value='1' <?php if ($ismenu) {
                                echo 'checked';
                            } ?>> <?php echo L('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='info[ismenu]' value='0' <?php if (!$ismenu) {
                                echo 'checked';
                            } ?>> <?php echo L('no'); ?></td>
                    </tr>
            ...
            <div id="div_setting_2" class="contentList pad-10 hidden">
                <table width="100%" class="table_form">
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='setting[ishtml]' value='1' <?php if ($setting['ishtml']) {
                                echo 'checked';
                            } ?>
                                   onClick="$('#category_php_ruleid').css('display','none');$('#category_html_ruleid').css('display','');$('#tr_domain').css('display','');"> <?php echo L('yes'); ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[ishtml]' value='0' <?php if (!$setting['ishtml']) {
                                echo 'checked';
                            } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='setting[content_ishtml]' value='1' <?php if ($setting['content_ishtml']) {
                                echo 'checked';
                            } ?> onClick="$('#show_php_ruleid').css('display','none');$('#show_html_ruleid').css('display','')"> <?php echo L('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[content_ishtml]' value='0' <?php if (!$setting['content_ishtml']) {
                                echo 'checked';
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="category_php_ruleid" style="display:<?php if ($setting['ishtml']) {
                                echo 'none';
                            } ?>">
                                <?php
                            ...
                            <div id="category_html_ruleid" style="display:<?php if (!$setting['ishtml']) {
                                echo 'none';
                            } ?>">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="show_php_ruleid" style="display:<?php if ($setting['content_ishtml']) {
                                echo 'none';
                            } ?>">
                                <?php
                            ...
                            <div id="show_html_ruleid" style="display:<?php if (!$setting['content_ishtml']) {
                                echo 'none';
                            } ?>">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='setting[create_to_html_root]' value='1' <?php if ($setting['create_to_html_root']) {
                                echo 'checked';
                            } ?> > <?php echo L('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[create_to_html_root]' value='0' <?php if (!$setting['create_to_html_root']) {
                                echo 'checked';
                            } ?> > <?php echo L('no'); ?>
                            （<?php echo L('create_to_rootdir_tips'); ?>）
                        </td>
                    </tr>
                    <tr id="tr_domain" style="display:<?php if (!$setting['ishtml']) {
                        echo 'none';
                    } ?>">
                        <th><?php echo L('domain') ?>：</th>
                        <td><input type="text" name="info[url]" id="url" class="input-text" size="50" value="<?php if (preg_match('/^http:\/\/([a-z0-9\-\.]+)\/$/i', $url)) {
                                echo $url;
                            } ?>"></td>
                    </tr>
                </table>
            ...
            <div id="div_setting_3" class="contentList pad-10 hidden">
                <table width="100%" class="table_form ">
                    <tr>
                        ...
                        <td>
                            <?php echo form::select($template_list, $setting['template_list'],
                                'name="setting[template_list]" id="template_list" onchange="load_file_list(this.value)"', L('please_select')) ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type='radio' name='template_child' value='1'> <?php echo L('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='template_child' value='0' checked> <?php echo L('no'); ?></td>
                        </td>
                    </tr>
                    <!--end 模版应用到子栏目配置-->
            ...
            <div id="div_setting_4" class="contentList pad-10 hidden">
                <table width="100%" class="table_form ">
                    ...
                    <tr>
                        ...
                        <td><textarea name='setting[meta_description]' id='meta_description' style="width:90%;height:50px"><?php echo $setting['meta_description']; ?></textarea>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table width="100%">
                            ...
                            <table width="100%" class="table-list">
                                ...
                                foreach ($roles as $roleid => $rolrname) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('init',
                                                $roleid); ?> value="init,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('add',
                                                $roleid); ?> value="add,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('edit',
                                                $roleid); ?> value="edit,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('delete',
                                                $roleid); ?> value="delete,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('listorder',
                                                $roleid); ?> value="listorder,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('push',
                                                $roleid); ?> value="push,<?php echo $roleid; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_roleid[]" <?php echo $disabled; ?> <?php echo $this->check_category_priv('move',
                                                $roleid); ?> value="move,<?php echo $roleid; ?>"></td>
                                    </tr>
                                <?php } ?>
                            ...
                            <table width="100%" class="table-list">
                                ...
                                foreach ($group_cache as $_key => $_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><input type="checkbox" name="priv_groupid[]" <?php echo $this->check_category_priv('visit', $_value['groupid'], 0); ?>
                                                                  value="visit,<?php echo $_value['groupid']; ?>"></td>
                                        <td align="center"><input type="checkbox" name="priv_groupid[]" <?php echo $this->check_category_priv('add', $_value['groupid'], 0); ?>
                    ...
                    <tr>
                        ...
                        <td><input type='radio' name='priv_child' value='1'> <?php echo L('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='priv_child' value='0' checked> <?php echo L('no'); ?></td>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="div_setting_6" class="contentList pad-10 hidden">
                <table width="100%" class="table_form">
                    <tr>
                        ...
                        <td><input name='setting[presentpoint]' type='text' value='<?php echo $setting['presentpoint']; ?>' size='5' maxlength='5'
                                   style='text-align:center'> <?php echo L('contribute_add_point_tips'); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo L('default_readpoint'); ?></th>
                        <td><input name='setting[defaultchargepoint]' type='text' value='<?php echo $setting['defaultchargepoint']; ?>' size='4' maxlength='4'
                                   style='text-align:center'> <select name="setting[paytype]">
                                <option value="0" <?php if (!$setting['paytype']) {
                                    echo 'selected';
                                } ?>><?php echo L('readpoint'); ?></option>
                                <option value="1" <?php if ($setting['paytype']) {
                                    echo 'selected';
                                } ?>><?php echo L('money'); ?></option>
                            </select> <?php echo L('readpoint_tips'); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo L('repeatchargedays'); ?></th>
                        <td>
                            <input name='setting[repeatchargedays]' type='text' value='<?php echo $setting['repeatchargedays']; ?>' size='4' maxlength='4'
