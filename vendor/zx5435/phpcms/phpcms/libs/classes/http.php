...
class http
{
    ...
    function post($url, $data = [], $referer = '', $limit = 0, $timeout = 30, $block = true)
    {
        $this->method = 'POST';
    ...
    function upload($url, $data = [], $files = [], $referer = '', $limit = 0, $timeout = 30, $block = true)
    {
        $this->method = 'POST';
        $boundary = "AaB03x";
    ...
    public static function curl(
        ...
        $config = [
            ...
            CURLOPT_POSTFIELDS     => is_array($data) && empty($headers) ? json_encode($data) : $data,
        ...
        if ($err) {
            ...
            $err_msg = 'Util curl error: ' . var_export($err, true) . ' , time spent is ' . $time_spend
                . 's, info is ' . var_export($info, true) . ' ,param is :'
