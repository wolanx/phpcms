...
<div id="toolbar">
	<div class="selCity">
    	<div class="right"><a href="javascript:void(0);" class="mark" onClick="addMarker();"><?php echo L('api_addmark','','map')?></a><a href="javascript:void(0);" onClick="removeMarker();" class="map"><?php echo L('api_resetmap','','map')?></a></div>
    	<strong id="curCity"><?php echo $defaultcity?></strong> [<a onClick="mapClose();" id="curCityText" href="javascript:void(0);"><?php echo L('api_changecity','','map')?></a>]
    </div>
    <div class="CityBox">
    	<h4><?php echo L('api_citylist','','map')?><div class="top"></div><a href="javascript:void(0);" class="close" onClick="mapClose();"></a></h4>
        <div class="content">
			<p>
			<?php foreach($hotcitys as $n=>$city) {?>
        	<a href="javascript:void(0);" onClick="keywordSearch('<?php echo trim($city)?>')"><?php echo $city?></a>
			<?php } ?>
			</p>
            <div class="line"></div>
