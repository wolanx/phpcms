...
return [
    ...
    'cookie_pre'       => 'PDZkN_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
    ...
    'upload_url'       => 'http://lcoalhost/uploadfile/', //附件路径
    'attachment_stat'  => '1', //是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担
    'cdn_path'         => 'http://localhost:1414/statics/', //CDN
    'js_path'          => 'http://lcoalhost/statics/js/', //CDN JS
    'css_path'         => 'http://lcoalhost/statics/css/', //CDN CSS
    'img_path'         => 'http://lcoalhost/statics/images/', //CDN img
    'app_path'         => 'http://lcoalhost/', //动态域名配置地址
    'charset'          => 'utf-8', //网站字符集
    ...
    'gzip'             => 1, //是否Gzip压缩后输出
    'auth_key'         => 'ZIa95152pDb1o5TGyFhg', //密钥
    'lang'             => 'zh-cn',  //网站语言包
    ...
    'phpsso'           => '1',    //是否使用phpsso
    'phpsso_appid'     => '1',    //应用id
    'phpsso_api_url'   => 'http://localhost:1414/phpsso_server',    //接口地址
    'phpsso_auth_key'  => 'utI6PD79LlxosHHhrGWRdGRxAfkPGYm7', //加密密钥
